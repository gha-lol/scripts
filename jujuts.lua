...
if game.PlaceId ~= 71410868559743 then
    ...
    local tab1Section3 = tab1:Section("Transform Placed Unit")
    
    local transformSpawnedDropdown
    local transformSpawnedSelected
    
    transformSpawnedDropdown = tab1Section3:Dropdown("Spawned Units", getSpawnedUnits(), function(unitt)
        transformSpawnedSelected = unitt
    end)
    ...
    tab1Section3:Button("Transform",function()
        local inst = workspace.Towers[transformSpawnedSelected]
    ...
    workspace.Towers.ChildAdded:Connect(function()
        ...
        transformSpawnedDropdown:Refresh(getSpawnedUnits(), false)
    end)
